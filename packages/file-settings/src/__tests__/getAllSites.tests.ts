		...
		expect(result).toEqual([
			{
				name: "mono-settings",
				mode: "default",
				packages: ["@sileajs/theme", "@sileajs/wp-source"],
			},
		]);
	});
		...
		expect(result).toEqual([
			{
				...
				mode: "default",
				packages: [
					"@sileajs/theme-default",
					"@sileajs/wp-source-default",
				],
			},
			{
				name: "settings-amp",
				mode: "amp",
				packages: ["@sileajs/theme-amp", "@sileajs/wp-source-amp"],
			},
		]);
	});
