...
[![Version](https://img.shields.io/npm/v/@sileajs/core.svg)](https://www.npmjs.com/package/@sileajs/core) [![npm](https://img.shields.io/npm/dw/@sileajs/core)](https://www.npmjs.com/package/@sileajs/core) [![License: The Hippocratic License 2.1](https://img.shields.io/badge/license-The%20Hippocratic%20License%202.1-%23000)](https://github.com/SileaJS/silea/blob/master/LICENSE)

The core package of the Silea framework. It contains babel & webpack configuration for Silea projects
...
This is a package internally used by [Silea CLI](https://docs.sileajs.com/silea-cli)

You'll find it as a dependency of your Silea project after you create it by doing

```sh
npx silea create [project-name]
```

> [More info on `npx silea create`](https://docs.sileajs.com/silea-cli/create)
...
These are the ones related to this package: https://community.sileajs.com/tags/c/feature-discussions/33/core

## Changelog

Have a look at the latest updates of this package in the [CHANGELOG](https://github.com/SileaJS/silea/blob/dev/packages/core/CHANGELOG.md)
