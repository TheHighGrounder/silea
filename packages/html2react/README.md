...
[![Version](https://img.shields.io/npm/v/@sileajs/html2react.svg)](https://www.npmjs.com/package/@sileajs/html2react) [![npm](https://img.shields.io/npm/dw/@sileajs/html2react)](https://www.npmjs.com/package/@sileajs/html2react) [![License: The Hippocratic License 2.1](https://img.shields.io/badge/license-The%20Hippocratic%20License%202.1-%23000)](https://github.com/SileaJS/silea/blob/master/LICENSE)

HTML to React converter for Silea.

Full info about this package can be found in the [docs](https://docs.sileajs.com/api-reference-1/silea-html2react)
...
These are the ones related to this package: https://community.sileajs.com/tags/c/feature-discussions/33/html2react

## Changelog

Have a look at the latest updates of this package in the [CHANGELOG](https://github.com/SileaJS/silea/blob/dev/packages/html2react/CHANGELOG.md)
