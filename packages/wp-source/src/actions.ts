...
import { ErrorData } from "@sileajs/source/types/data";
...
const actions: WpSource["actions"]["source"] = {
	...
	init: ({ state, libraries }) => {
		...
		try {
			...
			error(
				"Add the URL of your WordPress REST API in state.source.api."
			);
		}
