...
[![Version](https://img.shields.io/npm/v/@sileajs/router.svg)](https://www.npmjs.com/package/@sileajs/router) [![npm](https://img.shields.io/npm/dw/@sileajs/router)](https://www.npmjs.com/package/@sileajs/router) [![License: The Hippocratic License 2.1](https://img.shields.io/badge/license-The%20Hippocratic%20License%202.1-%23000)](https://github.com/SileaJS/silea/blob/master/LICENSE)

This package defines the common [interface](https://www.typescriptlang.org/docs/handbook/interfaces.html) (types) to build router packages for Silea

Some packages that [implement this interface](https://www.npmjs.com/browse/depended/@sileajs/router) are:

-   [`@sileajs/tiny-router`](https://www.npmjs.com/package/@sileajs/tiny-router)
...
These are the ones related to this package: https://community.sileajs.com/tags/c/feature-discussions/33/router

## Changelog

Have a look at the latest updates of this package in the [CHANGELOG](https://github.com/SileaJS/silea/blob/dev/packages/router/CHANGELOG.md)
