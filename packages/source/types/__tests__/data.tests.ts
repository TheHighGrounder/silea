import { expectType } from "silea/types/helpers";
import {
	Data,
	ErrorData,
	TaxonomyData,
	...
	items: [
		{
			id: 60,
			type: "post",
			link: "https://test.sileajs.com/2016/the-beauties-of-gullfoss",
		},
		{
			id: 57,
			type: "post",
			link:
				"https://test.sileajs.com/2016/shinjuku-gyoen-national-garden/",
		},
	],
	isReady: true,
	isFetching: false,
