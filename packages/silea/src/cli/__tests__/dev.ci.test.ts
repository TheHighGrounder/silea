...
describe("dev", () => {
	beforeEach(() => {
		mockedUtils.isSileaProjectRoot = jest.fn();
	...
	test("should get values from ENV variables", async () => {
		process.env.SILEA_DEV_TARGET = "es5";
		process.env.SILEA_DEV_PORT = "3001";
		process.env.SILEA_DEV_HTTPS = "true";
		process.env.SILEA_DEV_PRODUCTION = "true";
		process.env.SILEA_DEV_PUBLIC_PATH = "/public/path";
		process.env.SILEA_DEV_DONT_OPEN_BROWSER = "true";
