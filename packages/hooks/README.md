...
[![Version](https://img.shields.io/npm/v/@sileajs/hooks.svg)](https://www.npmjs.com/package/@sileajs/hooks) [![npm](https://img.shields.io/npm/dw/@sileajs/hooks)](https://www.npmjs.com/package/@sileajs/hooks) [![License: The Hippocratic License 2.1](https://img.shields.io/badge/license-The%20Hippocratic%20License%202.1-%23000)](https://github.com/SileaJS/silea/blob/master/LICENSE)

Collection of React hooks for Silea.
Full info about this package can be found in the [docs](https://docs.sileajs.com/api-reference-1/silea-hooks)
...
Some interesting hooks defined in this package are:

-   [`useInView`](https://docs.sileajs.com/api-reference-1/silea-hooks#useinview)
...
These are the ones related to this package: https://community.sileajs.com/tags/c/feature-discussions/33/hooks

## Changelog

Have a look at the latest updates of this package in the [CHANGELOG](https://github.com/SileaJS/silea/blob/dev/packages/hooks/CHANGELOG.md)
