...
import { warn, connect, useConnect } from "silea";
...
interface LinkProps {
	...
	/**
	 * Whether silea should automatically prefetch this link or not.
...
/**
 * The Link component that enables linking to internal pages in a silea app.
 *
 * Under the hood, this component uses the `actions.router.set(link)` method
 * from `@sileajs/tiny-router` and creates an `<a/>` tag.
 *
