# `@sileajs/comscore-analytics`

[![Version](https://img.shields.io/npm/v/@sileajs/comscore-analytics.svg)](https://www.npmjs.com/package/@sileajs/comscore-analytics) [![npm](https://img.shields.io/npm/dw/@sileajs/comscore-analytics)](https://www.npmjs.com/package/@sileajs/comscore-analytics) [![License: Apache--2.0](https://img.shields.io/badge/license-Apache%202-lightgrey)](https://github.com/sileajs/silea/blob/master/LICENSE)

Comscore Analytics package for Silea

## Install

```sh
npm i @sileajs/comscore-analytics
```
...
These are the ones related to this package: https://community.sileajs.com/tags/c/feature-discussions/33/comscore-analytics

## Changelog

Have a look at the latest updates of this package in the [CHANGELOG](https://github.com/sileajs/silea/blob/dev/packages/comscore-analytics/CHANGELOG.md)
