...
/**
 * Type declaration of a Silea action.
 *
 * @example
 *
 ...
 * ```
 *
 * @template Packages - The definition of all the packages that a Silea
 * package is aware of.
...
/**
 * Type declaration of a Silea async action.
 *
 * @example
 *
 * Without additional parameters:
...
/**
 * Type definition for Silea server actions, like `beforeSSR` or `afterSSR`.
 *
 * @template Packages - The definition of all the packages that a Silea
 * package is aware of.
 */
