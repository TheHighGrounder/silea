...
export interface Package {
	...
	state?: {
		/**
		 * State exposed in the `silea` namespace.
		 */
		silea?: {
			/**
			 * The name of the site
			 *
			 * Populated automatically by Silea.
			 */
			name?: string;
			...
			/**
			 * An array with the names of the Silea packages that are loaded for
			 * this site.
			 *
			 * Populated automatically by Silea.
			 */
			...
			/**
			 * Indicates if Silea is being run in the client or in the server.
			 *
			 * Populated automatically by Silea.
			 */
			...
			/**
			 * Indicates if Silea is in server-side rendering or client-side
			 * rendering context. The difference between this and `state.silea.platform`
			 * is that `state.silea.rendering` is still `"ssr"` in the first frame
			 ...
			 *
			 * Populated by the user in `silea.settings.js`.
			 */
			title?: string;
...
/**
 * An object containing Silea actions, or other objects containing actions.
 */
interface Actions {
