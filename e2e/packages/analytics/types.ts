...
import Analytics, { Pageview, Event } from "@sileajs/analytics/types";
import Source from "@sileajs/source/types";
import Router from "@sileajs/router/types";

/**
 * Package to do e2e testing of Silea's analytics library.
 */
interface TestAnalytics extends Package {
	...
	state: {
		...
		source: {
			/**
			 * Map of data describing each link in Silea.
			 */
